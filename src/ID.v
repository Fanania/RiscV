...
module DECODE_INSTR (
  output reg [`DATA_WIDTH-1:0] ID_Rd1,                       // Regfile outputs
  output reg [`DATA_WIDTH-1:0] ID_Rd2,
  ...
  always @(posedge clk) begin
    if (rst | Flush) begin
      ...
      ID_Rd1         [`DATA_WIDTH-1:0] <= Rd1_d0          [`DATA_WIDTH-1:0];
      ID_Rd2         [`DATA_WIDTH-1:0] <= RegOut2_d0      [`DATA_WIDTH-1:0];
